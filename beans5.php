...
$b = "[0;36m";
echo "$b          
█  LYKA  SCRIPT AUTO RATE AND AUTO POST";
echo "
█  version:XYZ";
$yellow = "[0;32m";
echo "$yellow
...
for ($x = 0;$x < $NoofDum;$x++) {
    $Dummy = readline('INPUT YOUR DUMMY USERNAME: ');
...
$yellow = "[1;31m";
echo "$yellow";
$user2 = readline('DUMMY UN1: ');
$user322 = readline('DUMMY UN2: ');
$user122 = readline('DUMMY UN3: ');
$user022 = readline('DUMMY UN4: ');
